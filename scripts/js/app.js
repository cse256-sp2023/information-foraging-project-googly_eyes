...
function main() {
    if (document.getElementById("teddy") != null) {
        ...
        document.getElementById("prospective-option").addEventListener("click", function () {
        ...
        document.getElementById("current-option").addEventListener("click", function () {
...
exports.clickedFinder = clickedFinder;
...
exports.clear = clear;
function changeStyleClick(idIn, type) {
...
exports.changeStyleClick = changeStyleClick;
var lastID = "";
function buttons() {
